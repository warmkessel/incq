...
public class EnqueueAuthor {
	...
	static public void enqueueAuthorTask(Long key, Language lang, AuthorStep step, boolean continueExpand) {
		enqueueAuthorTask(key, lang, step, 0, continueExpand);
	}
	static public void enqueueAuthorTask(Long key, Language lang, AuthorStep step, int position, boolean continueExpand) {
