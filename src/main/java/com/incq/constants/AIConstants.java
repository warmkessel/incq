...
//	public static final String AIIMAGE = "Generate an detailed drawing of: ";	
	...
	public static final String AIIREVIEW = "Respond only with five paragraphs in html.  Each paragraph should have a h4 title and a p element with two sentances.   Review this product and write an generaly positive review.  Find at least one not positive topic, do no list any amazon product or offering";	
